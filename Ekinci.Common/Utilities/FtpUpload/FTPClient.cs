...
namespace Ekinci.Common.Utilities.FtpUpload
{
    public class FTPClient : IFTPClient
    {
        ...
        {
            string CDNFtpHost = "ftp://storage.bunnycdn.com";
            string CDNFtpUsername = "ekinciapp";
            string CDNFtpPassword = "0a2888d3-3953-4bbd-9b7cf9150ab7-8712-49d1";
